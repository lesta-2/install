#!/bin/bash
#shadowsocks-libev obfs install by WISANG
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
echo "#############################################"
echo "Install Paket..."
apt-get install --no-install-recommends build-essential autoconf libtool libsWISANG-dev libpcre3-dev libev-dev asciidoc xmlto automake -y
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/lesta-2/install/main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/lesta-2/install/main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/lesta-2/install/main/cekss.sh"
wget -O renewss "https://raw.githubusercontent.com/lesta-2/install/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
