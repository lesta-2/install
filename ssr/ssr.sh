...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/lesta-2/install/main/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/lesta-2/install/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/lesta-2/install/main/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/lesta-2/install/main/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/lesta-2/install/main/renewssr.sh && chmod +x /usr/bin/renewssr
