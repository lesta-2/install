...
# ==================================================
# Link Hosting Kalian
WISANGvpn="raw.githubusercontent.com/https://raw.githubusercontent.com/lesta-2/install/main/main/ssh"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/lesta-2/install/main/vpn.zip
unzip vpn.zip
rm -f vpn.zip
